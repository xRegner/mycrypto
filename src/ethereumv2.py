...
cripto = {
    "nombre": "ethereum",
    "moneda": "mxn",
    "invertido": 0.00805347, #inversion en cripto
    "camper_mode": {
    ...
    "inversion_referencia": 402, #lo que pagaste por la cripto en tu moneda
    "porcentaje_ganancia": 3.2,
    "porcentaje_perdida": 0.5, #toleancia de perdida
    "notifica_perdidas": True,
    "oportunidad": 48500 #definido por el usuario cuando se quiere comprar
}
