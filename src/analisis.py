...
def analisis(cripto, _cripto_price):
#obtner el precio de la cripto desde la api
    cripto_price = _cripto_price
    ...
    try:
        arriba_del_promedio, abajo_del_promedio = calcula_tendencia(400, cripto["nombre"] ) #se puede parametrizar
    except Error as e:
